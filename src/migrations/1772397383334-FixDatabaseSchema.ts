...
export class FixDatabaseSchema1772397383334 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD "membership_start" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "users" ADD "membership_end" TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "membership_start"`);
    }
